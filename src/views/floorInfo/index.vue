<template>
   <div class="app-container">
    ...
    <el-table ref="listTabel" :data="listData.rows" height="calc(100vh - 255px)"  v-loading.body="listLoading" highlight-current-row>
      ...
      <el-table-column prop="room_amount" align="center" label="房间数量"/>
      <el-table-column prop="bed_amount" align="center" label="床位数量"/>
      <el-table-column prop="people_amount" align="center" label="居住人数"/>
      <el-table-column prop="empty_bed" align="center" label="空余床位"/>
      <el-table-column prop="empty_room" align="center" label="空余房间"/>
 ...
 <!-- 新增对话框 -->
 <el-dialog title="新增" :visible.sync="addDialogForm" width="35%">
  <el-form :model="addform" label-width="80px">
    ...
    <el-form-item label="楼房编号">
     ...
     <el-form-item label="房间类型">    
       <el-select v-model="addform.room_type" placeholder="房间类型" size="mini">
          <el-option label="单人间" :value="1"></el-option>
          <el-option label="双人间" :value="2"></el-option>
          <el-option label="三人间" :value="3"></el-option>
          <el-option label="四人间" :value="4"></el-option>
    ...
    <el-row>      
     ...
     <el-form-item label="房间数量" >    
        <el-input v-model="addform.room_amount" ></el-input>
    </el-form-item>
    </el-col>
    <el-col :span="11">
     <el-form-item label="床位数量" >    
        <el-input v-model="addform.bed_amount" ></el-input>
    </el-form-item>
    </el-col>
    </el-row>
    <el-row>  
    ...
    <el-col :span="8">
     <el-form-item label="空余床位" >    
      ...
      <el-col :span="8">
     <el-form-item label="空余房间">    
        <el-input v-model="addform.empty_room" ></el-input>
    </el-form-item>
    </el-col>
    </el-row>
  </el-form>
...
<!-- 详情弹框 -->
<el-dialog title="详情" :visible.sync="showDialogForm" width="35%">
  ...
  <el-row>  
    ...
    <el-form-item label="楼房编号">
      <el-input v-model="detailsData.floor_serialNumber" disabled></el-input>
       ...
       <el-col :span="11">
        <el-form-item label="房间类型">
       <el-input v-model="detailsData.room_type" disabled>       
       </el-input>
    </el-form-item>
       </el-col>
  </el-row>
  <el-row>
    ...
    <el-col :span="11">
    <el-form-item label="房间数量">
        <el-input v-model="detailsData.room_amount" disabled></el-input>
    </el-form-item>
    </el-col>
     <el-col :span="11">
    <el-form-item label="床位数量">
        <el-input v-model="detailsData.bed_amount" disabled></el-input>
    </el-form-item>
    </el-col>
    </el-row>
    <el-row>   
    ...
    <el-col :span="8">
    <el-form-item label="空余房间">
        <el-input v-model="detailsData.empty_room" disabled></el-input>
    </el-form-item>
    </el-col>
    </el-row>
  </el-form>
...
<!-- 修改弹框 -->
<el-dialog title="修改" :visible.sync="updateDialogForm" width="35%">
  <el-form :model="updateData" label-width="80px">
    ...
    <el-form-item label="楼房编号">
     ...
     <el-col :span="11">
    <el-form-item label="房间类型">
          <el-select v-model="updateData.room_type" size="mini">
          <el-option label="单人间" :value="1"></el-option>
          <el-option label="双人间" :value="2"></el-option>
          <el-option label="三人间" :value="3"></el-option>
          <el-option label="四人间" :value="4"></el-option>
    ...
    <el-col :span="11">
    <el-form-item label="房间数量">
        <el-input v-model="updateData.room_amount"></el-input>
    </el-form-item>
    </el-col>
     <el-col :span="11">
    <el-form-item label="床位数量">
        <el-input v-model="updateData.bed_amount"></el-input>
    </el-form-item>
    </el-col>
    </el-row>
    <el-row>   
    ...
    <el-col :span="8">
    <el-form-item label="空余房间">
        <el-input v-model="updateData.empty_room"></el-input>
    </el-form-item>
    </el-col>
    </el-row> 
  </el-form>
...
<script>
import {getFloorList,addFloor,updateFloor,deleteFloor} from '@/api/floorInfo'
export default {
    data() {
    return {
      addDialogForm:false,
  ...
  updateHandle(){
   updateFloor(this.updateData).then(()=>{
      this.updateDialogForm=false
      this.getTableList()
   })
  },
  del(r,i){ 
  deleteFloor(r.id).then(()=>{
